...
##  {auto-animate="true" data-background-image="chapter3.png"}
...
## Seasonality of PAR on SCM {data-background-image="par-3d-bg1.png" background-size="1500px"}
...
## Seasonality of PAR on SCM {data-background-image="par-3d-bg2.png" background-size="1500px"}
...
::: {.column width="50%"}
![](settling%20equation.png) - This disproportion in mass and volume makes the phytoplankton (especially diatoms) positively buoyant after a critical size range (Gross and Zeuthen, 1948)
:::
:::
...
::: columns
::: {.column width="50%"}
![](set_video.mov){width="600" height="500"}
:::
...
![](bloom_map2.png){.absolute top="80" left="50"}

## When it blooms

![](bloom_map3.png){.absolute top="80" left="50"}

## Influence of extreme events

![](bloom_map4.png){.absolute top="80" left="50"}

## But it is entirely absent in early years

![](bloom_map5.png){.absolute top="80" left="50"}
...
## Trophic dynamics of SubSurface layers {data-background-image="lv_model.png" background-size="1300px"}
...
##  {auto-animate="true" data-background-image="climate.png"}
...
ts_neas<- ggplot(ts_neas_dat, aes(x = date, y = den,group=1)) + geom_line(size=1)+geom_smooth()+ ylab("Potential Density")+ xlab("year")
...
::: r-stack
![](feb10wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](feb15wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](feb20wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](feb25wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar1wave.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar06wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar11wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar16wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar21wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}

![](mar26wav.png){.fragment .absolute width="600" height="700" top="50" left="200"}
:::

## Early startification leads to early blooms {background-color="aquamarine"}
...
:::
![](wave_decomposs_legend.png){width="300" height="150"}
:::
:::
...
::: r-stack
![](pden1.png){.fragment width="1000" height="500"}

![](pden2.png){.fragment width="1000" height="500"}

![](pden3.png){.fragment width="1000" height="500"}
...
library(colorRamps)
bisi<- raster("bisi.nc")
bisi_dat<- rasterToPoints(bisi)
  bisi_dat<- data.frame(rasterToPoints(bisi))
 
 bisi_val<- bisi_dat[order(bisi_dat$layer, decreasing=TRUE),]
 value  <- 100 * bisi_dat$layer / max(bisi_dat$layer)
 col<- matlab.like(9)[floor(10 * value/100) + 1]
 earth<- "world.topo.bathy.200412.3x5400x2700.jpg"
 globejs(img = earth,
         lat = bisi_dat$y,
         long = bisi_dat$x,
         val = bisi_dat$layer,color = col,bg = "white")
```
...
##  {auto-animate="true" data-background-image="forecast.png"}
...
## Summary and Conclusion {background-color="aquamarine" font-size="3em"}
