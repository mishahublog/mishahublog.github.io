...
::: {style="margin-top: 100px; font-size: 2em; color:aquamarine ;"}
Early occurrence of Phytoplankton blooms in NEAS ?
:::
...
## Potential density anomalies over the decades
...
::: r-fit-text
::: incremental
-   The SST-PDEN ratio relationship with SCM is utlized to derive Biologically Influenced Stratification Index (BISI) \_ BISI describes the probable SCM in locations, where the SST is increasing and density decreases
:::
:::
:::
:::
